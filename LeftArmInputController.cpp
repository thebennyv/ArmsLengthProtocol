...
{
    LeftArmInputController::AttachedButton* attachedButton = (LeftArmInputController::AttachedButton*)param;
    attachedButton->controller->buttonPressed(attachedButton, LeftArmInputController::LONGPRESS);
}
...
LeftArmInputController::LeftArmInputController(
    ...
    indexFinger(this, (int)LeftArmPin_e::IndexFingerButton, true, true),
    middleFinger(this, (int)LeftArmPin_e::MiddleFingerButton, true, true),
    ringFinger(this, (int)LeftArmPin_e::RingFingerButton, true, true),
    pinkyFinger(this, (int)LeftArmPin_e::PinkyFingerButton, true, true)
{
...
void LeftArmInputController::toggleRightArmRocket()
{
    bool isClosed = true;
